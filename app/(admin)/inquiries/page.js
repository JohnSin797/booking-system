...
import ReadReply from "@/app/components/modals/views/readReply"
...
export default function Inquiries () {
    ...
    const readReply = indx => {
        setReplyDetails(inquiries[indx])
        setOpenReply(true)
    }
    ...
    return (
        <>
            ...
            <main className="absolute w-full md:w-4/5 top-20 right-0 p-6">
                ...
                <ReadReply details={replyDetails} status={openReply} setStatus={setOpenReply} />
                                                    ...
                                                    <td className="text-white border border-slate-900 p-2">
                                                        {
                                                            ...
                                                            <div>
                                                                ...
                                                                <Link href={'/inquiries/reply/create/'+item.id} className="text-blue-400 hover:underline">send reply</Link>
                                                            </div>
                                                        }
                                                    </td>
